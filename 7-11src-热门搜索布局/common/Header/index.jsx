  ...
  if(show){
    ...
    <SearchInfo>
      ...
      <SearchInfoList>
        ...
        <SearchInfoItem>母婴</SearchInfoItem>
        <SearchInfoItem>美妆</SearchInfoItem>
        <SearchInfoItem>财经</SearchInfoItem>
        <SearchInfoItem>法律</SearchInfoItem>
      </SearchInfoList>
    </SearchInfo>
    )
  }else{
...
const mapStateToProps = (state)=>{// 这里state就是store里的所有数据
  return {
    ...
    // state.getIn(['header','focused']) 和上一行一样的意思
  }
}
